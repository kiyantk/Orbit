    ...
    <div className="welcome-popup-overlay">
      <div className="heic-popup">
        ...
        <div className="heic-popup-content" style={{ placeItems: "center" }}>
          <p>
            Orbit can help you generate thumbnails for <strong>HEIC</strong>{" "}
            images. Creating them directly inside Orbit would be too slow, so we
            provide a small Python script you can run locally to generate them
            much faster.
            <br />
            <br />
            <strong>Before you start:</strong> Make sure you have{" "}
            <strong>Python 3</strong> installed, then run this command in a
            terminal to install the required libraries:
            <br />
          ...
          <ol
            style={{ textAlign: "left", margin: "0 auto", maxWidth: "500px" }}
          >
            <li>
            ...
            <li>
              Run the script with Python — it will create thumbnails and place
              them in a <code>/thumbs</code> folder.
            </li>
            <li>
          ...
          <br />
          <p>
            <em>Note:</em> Your original HEIC files are never modified — only
            small JPEG thumbnails are created.
          </p>
